...
export const OPENMARKET_URL = Config.OPENMARKET_URL;
export const OPENMARKET_API_KEY = Config.OPENMARKET_API_KEY;
export const PLATEFORM_URL = Config.PLATEFORM_URL;

export const TEST_USERID = Config.TEST_USERID;
